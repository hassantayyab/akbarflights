  ...
  render() {
    return (
      <div>
        ...
        <div
          id="div"
          dangerouslySetInnerHTML={this.redraw()}
          onMouseUp={() => {
            this.enable();
            this.props.selectText(document.getElementById("div"), numb, n, id);
          }}
        />
        <Popup
          ...
          <form>
            ...
            <input
              ...
              onClick={() => {
                ...
                this.props.submit(this.refs.newItem.value, count, n, id);
              }}
            />
          </form>
        </Popup>
...
function mapStateToProps(state) {
  // console.log('in container:',state.CommentBox);
  console.log("in container-A:", state.answer);
  numb = state.answer.numb;
  return {
    comments: state.CommentBox,
    answer: state.answer
  };
}
