...
import {submit} from '../actions/submit4';
...
function mapStateToProps(state){
	// console.log('in container:',state.CommentBox4);
	// console.log('in container-A:',state.answer4);
	numb = state.answer4.numb;
	return {
		comments: state.CommentBox4,
